...
- [ ] Инициализация проекта с electron-vite react-ts template
- [ ] Настройка TypeScript конфигурации
- [ ] Настройка Tailwind CSS
- [ ] Настройка ESLint и Prettier
- [ ] Создание базовой структуры папок
- [ ] Настройка скриптов сборки и разработки

### Этап 2: Базовая архитектура (2-3 дня)

- [ ] Создание React Context для управления состоянием
- [ ] Определение TypeScript типов для карт и файлов
- [ ] Создание базовых сервисов (FileService, MapService)
- [ ] Настройка Electron IPC коммуникации
- [ ] Создание базовых хуков (useFiles, useMaps)

### Этап 3: UI компоненты (3-4 дня)

- [ ] Создание компонента FileManager
  - [ ] Drag & Drop загрузка файлов
  - [ ] Список загруженных файлов
  - [ ] Управление видимостью файлов и карт
- [ ] Создание компонента MapViewer
  - [ ] Canvas для отображения карт
  - [ ] Координатная сетка
  - [ ] Цветовое кодирование точек
- [ ] Создание компонента ControlPanel
  - [ ] Кнопки управления
...
- [ ] Drag & Drop работает
- [ ] Canvas отображает тестовые данные
- [ ] Управление видимостью работает
